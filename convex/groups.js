...
//     if (group.createdBy !== user.subject) {
//       throw new ConvexError("You cannot delete a group you didn't create");
//     }

//     // 1. Delete all Expenses in this group
//     const expenses = await ctx.db
//       .query("expenses")
...
//     // 2. Delete all Settlements in this group (If you have this feature)
//     const settlements = await ctx.db
//       .query("settlements")
//       .filter((q) => q.eq(q.field("groupId"), args.id))
//       .collect();
...
//     return "Group and all related data deleted";
//   },
// });